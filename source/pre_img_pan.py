...
#	image = _get_image(url)
	...
	if (isValid(data['PAN'])):
		None
	elif (isValid(data['Father Name'])):
		data['PAN'] = data['Father Name']
	elif(isValid(data['Date of Birth'])):
		data['PAN'] = data['Date of Birth']
	elif (isValid(data['Name'])):
		data['PAN'] = data['Name']
	else:
		data['PAN'] = 'Not Found'
