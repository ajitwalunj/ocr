...
def parse_args():
	...
	parser.add_argument('--cfg', dest="DARKNET_CFG_FILE", default="yolov-obj.cfg", help="Darknet configuration file")
	parser.add_argument('--weights', dest="DARKNET_WEIGHTS", default="yolo-obj_aadhar_9000.weights", help="Weights for Darknet")
...
if DARKNET:
	...
	DARKNET_WEIGHTS   = os.path.realpath("content/darknet/backup/yolo-obj_aadhar_9000.weights")
